...
// import counter from './reducers'; // 是对数据的操作
...
class Son2 extends PureComponent{
  ...
  x = () => {
    ...
    // evnetHub.trigger('我想花钱',/* action type */ 100 /* payload*/);  // 用下面的一行改写

    store.dispatch({ type: '我想花钱', payload: 100 }) //  dispatch的东西叫action   触发的这个事件由谁来接管呢
  }
